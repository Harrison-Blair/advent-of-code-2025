...
1. > O(n) time complexity with a traditional loop

Adjacency list generation?
    - Still lots of memory access -> maybe less compute overall?
        (need to loop through adj) (Do not need to compute multiple times)